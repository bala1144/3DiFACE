...
def add_training_options(parser):
    ...
    # TODO : changed by bala for the configuration based training
    group.add_argument("--save_dir", default="./tmp", required=False, type=str,
...
def train_args():
    ...
    parser.add_argument("--cfg", default="", type=str, help="Load the arguments from the config")
