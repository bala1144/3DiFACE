...
class RingNet_lip_embedding(nn.Module):
    ...
    def __init__(self):
        ...
        flame_model_path = os.path.join(os.getenv('HOME'), "projects/NeuralMotionSynthesis/FLAMEModel",
        ...
        static_embedding_path = os.path.join(os.getenv('HOME'), "projects/NeuralMotionSynthesis/FLAMEModel",
    ...
    def extract_lip_keypoints(self, vertices):
        ...
        # extract the landmarks corresponding to lips
        return landmarks
